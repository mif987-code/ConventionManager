...
export const specialVouchers = {
  ...
  create: (data: { convention_id: number; category?: string | null; format?: string | null; entry_cost?: number | null; name: string; description?: string; icon?: string; color?: string; max_awards?: number; voucher_type?: string }) =>
...
export const packages = {
  ...
  create: (name: string, description: string | null, days: number, cost: number, preregCost: number | null, preregStartDate: string | null, preregEndDate: string | null, regularVoucherAmount: number, packageType: string = 'day_pass', maxAge: number | null = null) =>
    request<any>('/packages', { method: 'POST', body: JSON.stringify({ name, description, days, cost, prereg_cost: preregCost, prereg_start_date: preregStartDate, prereg_end_date: preregEndDate, regular_voucher_amount: regularVoucherAmount, package_type: packageType, max_age: maxAge }) }),
  update: (id: number, name: string, description: string | null, days: number, cost: number, preregCost: number | null, preregStartDate: string | null, preregEndDate: string | null, regularVoucherAmount: number, is_active: boolean, packageType: string = 'day_pass', maxAge: number | null = null) =>
    request<any>(`/packages/${id}`, { method: 'PUT', body: JSON.stringify({ name, description, days, cost, prereg_cost: preregCost, prereg_start_date: preregStartDate, prereg_end_date: preregEndDate, regular_voucher_amount: regularVoucherAmount, is_active, package_type: packageType, max_age: maxAge }) }),
