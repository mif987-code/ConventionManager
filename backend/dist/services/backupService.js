...
exports.runFullBackup = runFullBackup;
...
function runFullBackup() {
    return new Promise((resolve, reject) => {
        ...
        pgDump(filename, '', async (err) => {
            ...
            await (0, dropboxService_1.uploadBackupToDropbox)(path_1.default.join(BACKUP_DIR, filename), filename);
            resolve({ filename });
        });
    });
}
...
function startBackupSchedule() {
    ...
    console.log((0, dropboxService_1.isDropboxBackupConfigured)()
